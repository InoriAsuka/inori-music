...
| `GET` | `/api/v1/admin/media/objects?lifecycleState=...` | List media object metadata by lifecycle state. |
| `GET` | `/api/v1/admin/media/objects?assetKind=...` | List media object metadata by asset kind. |
...
| `POST` | `/api/v1/admin/media/objects/{id}/lifecycle` | Update media object lifecycle metadata. |
